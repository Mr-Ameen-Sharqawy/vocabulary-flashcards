import { ArrowRight, KeyRound, Loader2, LogOut, Plus, ShieldCheck, Users } from "lucide-react";
...
export default function TeacherPortal({ onBack }: TeacherPortalProps) {
  ...
  function addStudent(event: FormEvent<HTMLFormElement>) {
    ...
    createStudent.mutate({ displayName, username, password }, {
      onSuccess: () => {
        setDisplayName("");
        setUsername("");
        setPassword("");
