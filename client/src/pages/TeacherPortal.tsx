...
export default function TeacherPortal({ onBack }: TeacherPortalProps) {
  ...
  function addStudent(event: FormEvent<HTMLFormElement>) {
    ...
    createStudent.mutate({ displayName, username, password, maxDevices, accessType }, {
      onSuccess: () => {
        setDisplayName("");
        setUsername("");
        setPassword("");
