...
<head>
  ...
  <style>
    /* STYLE: دفتر رحلة دراسي عصري — زخارف هادئة خلف المحتوى مع تباين عالٍ للبطاقات. */
    body{background:radial-gradient(circle at 82% 8%,rgba(244,200,74,.18) 0 72px,transparent 74px),radial-gradient(circle at 10% 84%,rgba(112,198,181,.18) 0 104px,transparent 106px),radial-gradient(circle at 1px 1px,rgba(23,58,99,.07) 1px,transparent 0) 0 0/18px 18px,var(--paper)}
    .main{position:relative;overflow:hidden;isolation:isolate;background:linear-gradient(90deg,rgba(30,95,168,.045) 1px,transparent 1px) 0 0/42px 42px,linear-gradient(0deg,rgba(30,95,168,.035) 1px,transparent 1px) 0 0/42px 42px,radial-gradient(circle at 86% 12%,rgba(244,200,74,.19) 0 2px,transparent 2.7px) 0 0/27px 27px,linear-gradient(145deg,rgba(255,255,255,.55),rgba(251,248,239,.22))}
    .main:before{content:"";position:absolute;z-index:-1;top:62px;left:-72px;width:238px;height:238px;border:18px solid rgba(112,198,181,.15);border-radius:47% 53% 41% 59%/58% 42% 58% 42%;box-shadow:48px 44px 0 -9px rgba(239,138,117,.10),86px -30px 0 -22px rgba(244,200,74,.28);transform:rotate(-12deg);pointer-events:none;animation:floatDoodle 8s ease-in-out infinite}
    .main:after{content:"";position:absolute;z-index:-1;right:-102px;bottom:10px;width:330px;height:330px;border:2px dashed rgba(30,95,168,.14);border-radius:50%;box-shadow:inset 0 0 0 27px rgba(244,200,74,.08),inset 0 0 0 74px rgba(112,198,181,.05);pointer-events:none}
    .main>*{position:relative;z-index:1}.top{background:linear-gradient(90deg,rgba(251,248,239,.98),rgba(255,253,246,.91) 58%,rgba(232,241,251,.65))}.brand{padding:4px 10px 4px 4px;border-left:3px solid var(--gold)}.brand img{width:52px;height:52px;padding:3px;border:2px solid rgba(244,200,74,.64);border-radius:14px 7px 14px 7px;background:#fffdf5}.brand strong{font-size:21px;letter-spacing:-.035em}.hero{min-height:160px;border:1px solid rgba(23,58,99,.08)}.hero:after{content:"";position:absolute;top:16px;left:20px;width:112px;height:42px;border-top:2px dashed rgba(30,95,168,.28);border-radius:50%;box-shadow:32px 28px 0 -14px rgba(244,200,74,.65),72px 4px 0 -14px rgba(112,198,181,.72);opacity:.85}.hero-copy{padding:19px 56px 20px 22px}.hero h2{font-size:clamp(25px,3vw,35px);line-height:1.1}.progress{position:relative;margin:18px 0 15px;padding:12px 15px 12px 20px;border:1px dashed rgba(30,95,168,.22);border-right:5px solid var(--gold);border-radius:7px 13px 13px 7px;background:rgba(255,253,246,.78);box-shadow:0 7px 16px rgba(23,58,99,.045)}.progress:before{content:"✦  •  •  •";position:absolute;left:14px;top:-10px;padding:0 7px;color:var(--coral);background:var(--paper);font:900 10px/1 "Nunito Sans";letter-spacing:.12em;direction:ltr}.track{height:10px;border:1px solid rgba(23,58,99,.1);background:repeating-linear-gradient(90deg,#dde5ec 0 13px,#f8fafc 13px 18px)}.track i{background:repeating-linear-gradient(90deg,var(--gold) 0 13px,#ffd96f 13px 18px)!important}.card{border:2px solid rgba(255,255,255,.94);border-top-color:var(--gold);box-shadow:0 24px 44px rgba(23,58,99,.19),0 2px 0 rgba(244,200,74,.42)}
    /* Design context: a plain white pre-reveal face focuses the learner on the vocabulary word. */
    .front{background:#fff!important}.front:before,.front:after{content:none!important;display:none!important}
    @keyframes floatDoodle{0%,100%{transform:rotate(-12deg) translate3d(0,0,0)}50%{transform:rotate(-8deg) translate3d(8px,-9px,0)}}
  </style>
</head>
<body>
